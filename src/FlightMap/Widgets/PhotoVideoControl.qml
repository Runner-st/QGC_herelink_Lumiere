...
Rectangle {
    ...
    height:     (hdmiToggleButton.visible ? hdmiToggleButton.height + (_margins * 2) : 0)
                + (customCameraControls.visible ? customCameraControls.implicitHeight + _margins : 0)
                + mainLayout.implicitHeight + (_margins * 3) + 30

...
installer {
    ...
    AndroidBuild {
        ...
        isEmpty(_ANDROID_KEYSTORE_PASSWORD) {
            ...
            QMAKE_POST_LINK += && cp android-build/build/outputs/apk/debug/android-build-debug.apk package/QGroundControl-Herelink.apk
        } else {
            ...
            QMAKE_POST_LINK += && cp android-build/build/outputs/apk/release/android-build-release-signed.apk package/QGroundControl-Herelink.apk
        }
    }
}
